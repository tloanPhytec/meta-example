# Branch am62-scarthgap-dataPartition
...
This was tested with the phyCORE-AM62x's BSP PD24.1.1
...
```sh
git clone https://github.com/tloanPhytec/meta-example.git -b am62-scarthgap-dataPartition
```
