# Branch am64-kirkstone-linuxApps

This branch serves as a reference for adding custom C code applications to PHYTEC's phyCORE-AM64x BSP.
...
This was tested with BSP-Yocto-Ampliphy-AM64x-PD23.2.1
...
```sh
git clone https://github.com/tloanPhytec/meta-example.git -b am64-kirkstone-linuxApps
```
